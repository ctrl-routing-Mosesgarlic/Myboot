//! A compact public-domain 8x8 bitmap font (font8x8_basic subset) for the
//! printable ASCII range, plus the text renderer's glyph lookup (report §4.5).
//! Bit 0 (LSB) of each row byte is the leftmost pixel.

/// 8x8 glyphs for ASCII 0x20..=0x7E. Index by `ch as usize - 0x20`.
